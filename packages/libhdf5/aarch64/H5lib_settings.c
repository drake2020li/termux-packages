...
const char H5libhdf5_settings[]=
	...
	"             Installation point: /data/local/tmp/tmadb/files/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	"                     Build Mode: Release\n"
	...
	"                        LDFLAGS: -Wl,--as-needed -L/data/local/tmp/tmadb/files/usr/lib\n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS: \n"
	"                Extra libraries: m;dl\n"
	"                       Archiver: /data/local/tmp/tmadb/files/usr/bin/ar\n"
	"                         Ranlib: /data/local/tmp/tmadb/files/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: YES\n"
	"                     C Compiler: /data/local/tmp/tmadb/files/usr/bin/clang 15.0.7\n"
	"                       CPPFLAGS: \n"
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS:  -std=c99 -Oz -fstack-protector-strong -I/data/local/tmp/tmadb/files/usr/include\n"
	...
	"               Module Directory: /data/local/tmp/tmadb/files/files/home/termux.libhdf5.build/mod\n"
	"\n"
	"                            C++: ON\n"
	"                   C++ Compiler: /data/local/tmp/tmadb/files/usr/bin/clang++ 15.0.7\n"
	"                      C++ Flags:  -Oz -fstack-protector-strong -I/data/local/tmp/tmadb/files/usr/include\n"
