...
##
TERMUX_APP__DATA_DIR="/data/local/tmp/tmadb"
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
##
TERMUX_REGEX__APP_DATA_DIR_PATH='^(((/data/local/tmp)|(/data/data)|(/data/user/[0-9]+)|(/mnt/expand/[^/]+/user/[0-9]+))/[^/]+)$'
...
TERMUX_REPO_APP__DATA_DIR="/data/local/tmp/tmadb"
TERMUX_REPO__CORE_DIR="/data/local/tmp/tmadb/termux/core"
TERMUX_REPO__APPS_DIR="/data/local/tmp/tmadb/termux/apps"
TERMUX_REPO__ROOTFS="/data/local/tmp/tmadb/files"
TERMUX_REPO__HOME="/data/local/tmp/tmadb/files/home"
TERMUX_REPO__PREFIX="/data/local/tmp/tmadb/files/usr"
